...
export const AuthorIcon = () => h(IconBase, { name: "author" }, () => h("path", {
...
export const CalendarIcon = () => h(IconBase, { name: "calendar" }, () => h("path", {
...
export const CategoryIcon = () => h(IconBase, { name: "category" }, () => h("path", {
...
export const EyeIcon = () => h(IconBase, { name: "eye" }, () => h("path", {
...
export const FireIcon = () => h(IconBase, { name: "fire" }, () => h("path", {
...
export const TagIcon = () => h(IconBase, { name: "tag" }, () => h("path", {
...
export const TimerIcon = () => h(IconBase, { name: "timer" }, () => h("path", {
...
export const WordIcon = () => h(IconBase, { name: "word" }, () => [
    h("path", {
...
export const BacktoTopIcon = () => h(IconBase, { name: "back-to-top" }, () => [
    h("path", {
