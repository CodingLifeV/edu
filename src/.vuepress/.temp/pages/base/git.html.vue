<template><div><h2 id="git-是什么" tabindex="-1"><a class="header-anchor" href="#git-是什么" aria-hidden="true">#</a> Git 是什么？</h2>
<p><strong>Git 是分布式的版本控制系统</strong>。在我们项目开发过程中，往往会遇到这样的问题：</p>
<ul>
<li>在本地编写代码时，一旦你把代码改乱了，或者误删了某些文件，项目难以退回到之前未修改的模样</li>
<li>在本地编写代码时，担心项目修改出错，拷贝了许多份项目的副本，随着时间的推移，本地副本越来越多，已经忘记了哪些副本修改了哪些代码</li>
</ul>
<p>版本控制系统 Git 很好的解决了以上难题，要想使用 Git 进行一些列操作，首先要下载安装最近版本的 Git <a href="https://git-scm.com/downloads" target="_blank" rel="noopener noreferrer">Git - Downloads (git-scm.com)<ExternalLinkIcon/></a></p>
<h2 id="初次运行-git-前的配置" tabindex="-1"><a class="header-anchor" href="#初次运行-git-前的配置" aria-hidden="true">#</a> 初次运行 Git 前的配置</h2>
<p>安装好 Git 之后，我们需要在本地电脑上进行一些简单的配置，具体配置流程如下：</p>
<ol>
<li>
<p>打开 <strong>Git Bash</strong>，设置你的用户名和邮件地址</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">git</span> config <span class="token parameter variable">--global</span> user.name <span class="token string">"your_name"</span>
...
<p>:::: code-group</p>
<p>::: code-group-item Windows</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>clip <span class="token operator">&lt;</span> ~/.ssh/id_rsa.pub
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>:::</p>
<p>::: code-group-item Mac:active</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>pbcopy <span class="token operator">&lt;</span> ~/.ssh/id_rsa.pub
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>:::</p>
<p>::: code-group-item Linux</p>
...
<p>::::</p>
<p>之后登录 Github 账户，点击账户任何页面右上角个人资料图像 <strong>Setting</strong>，在侧边栏的 <strong>Access</strong> 部分，单击 <strong>SSH and GPS keys</strong>，点击 <strong>New SSH key</strong> 或者 <strong>Add SSH key</strong>，将上面复制的 SSH 公钥粘贴进去，并为该密钥起一个简短的标号 <strong>Title</strong></p>
<div class="custom-container tip">
<p class="custom-container-title">Tips</p>
<p>1、默认情况下，用户的 SSH 密钥存储在其 <code v-pre>~/.ssh</code> 目录下。 进入该目录并列出其中内容，你便可以快速确认自己是否已拥有密钥：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 测试</span>
...
<p>当你对 Git 进行配置，以及拥有了 Github 账户之后，你便可以使用 Git 与 Github 管理你的项目了。试想有一个名为 <code v-pre>CodingLife</code> 的 Java 项目（只有一个<code v-pre>Test.java</code>文件），本地存储在名为 CodingLife 的文件夹中，<code v-pre>Test.java</code> 代码如下所示：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// Test.java</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在编写代码过程中，我们可以使用 Git 结合 Github 仓库来管理该项目，具体流程如下：</p>
<ol>
<li>
...
<p>（1）本地仓库有一个 master 分支（前面提过<code v-pre>git init</code>命令会为我们自动创建一个 master 分支）</p>
...
<p>至此，我们完成了使用 Git 与 GitHub 管理项目的简单操作。当我们再次在本地电脑对项目进行修改之后，比如我们修改了 Test.java 的信息：</p>
<p>:::: code-group</p>
<p>::: code-group-item 修改后</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果更改内容无误，只需要使用以下命令便可将更改信息推送到与之关联的 Github 仓库中：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">git</span> <span class="token function">add</span> <span class="token builtin class-name">.</span>
...
<p>参考链接：</p>
<ul>
<li><a href="https://stackoverflow.com/questions/65173291/git-push-error-src-refspec-main-does-not-match-any-on-linux" target="_blank" rel="noopener noreferrer">master分支与主分支的区别<ExternalLinkIcon/></a></li>
<li><a href="https://www.liaoxuefeng.com/wiki/896043488029600" target="_blank" rel="noopener noreferrer">Git教程<ExternalLinkIcon/></a></li>
<li><a href="https://git-scm.com/book/zh/v2" target="_blank" rel="noopener noreferrer">Git 官方文档<ExternalLinkIcon/></a></li>
</ul>
<h2 id="git-版本回退" tabindex="-1"><a class="header-anchor" href="#git-版本回退" aria-hidden="true">#</a> <a id="_link_git2">Git 版本回退</a></h2>
<p>有时候，当我们使用 Git 提交本地项目到 Github 仓库之后，发现提交的内容有误，希望恢复项目到之前的版本，此时，Git 版本回退可以帮助我们解决这一问题。</p>
<p>比如我们继续对 CodingLife 项目中的文件 <code v-pre>Test.java</code> 进行修改并提交到远程库：</p>
<p>:::: code-group</p>
<p>::: code-group-item 修改后</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test</span> <span class="token punctuation">{</span>
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token function">git</span> push origin master
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>等第二天我们发现删除掉了重要的内容，我们希望恢复之前的内容，使用 Git 版本回退可以解决该问题，流程如下：</p>
<ol>
<li>
<p>查看提交日志</p>
...
<p>2、<code v-pre>--hard</code> 后面也可加想要回退版本的版本号前几位来回退到具体的版本</p>
</div>
<p>当版本回退之后，我们在看 Test.java 代码，发现已经回退到了修改前的代码。</p>
<p>:::: code-group</p>
<p>::: code-group-item 回退后</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test</span> <span class="token punctuation">{</span>
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"编码人生-bmrs.top"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
      <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"增加一行输出——编码人生-bmrs.top"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p>在<a href="#_link_git2">Git 版本回退</a>里，我们知道 Git 会把每一次提交信息串成一条时间线，这条时间线就是一个分支。在 Git 中，创建、合并和删除分支非常快，所以 Git 鼓励我们使用分支完成某些任务，任务完成之后合将内容并到主分支，之后再删掉分支，这和直接在 <code v-pre>master</code> 分支上工作效果是一样的，但过程更安全。</p>
<p>在 CodingLife 项目下分支的创建合并删除流程如下：</p>
<ol>
<li>
...
<p class="custom-container-title">知识点</p>
<p>1、以上命令可以拆解成两条命令：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">git</span> branch dev    <span class="token comment"># 创建 dev 分支</span>
<span class="token function">git</span> checkout dev  <span class="token comment"># 切换到 dev 分支</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>2、可以查看当前分支情况，&quot;*&quot; 号表示当前分支</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>wyj_p@DESKTOP-OHURAP1 MINGW32 /d/CodingLife <span class="token punctuation">(</span>dev<span class="token punctuation">)</span>
...
<li>
<p>在 dev 分支上修改内容并提交</p>
<p>我们继续对 CodingLife 项目的<code v-pre>Test.java</code> 文件进行修改（增加一行输出语句），不同的是现在是在 dev 分支上，而不是在 master 分支：</p>
<p>:::: code-group</p>
<p>::: code-group-item 修改后</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test</span> <span class="token punctuation">{</span>
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
public class Test <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时 master 分支的内容停留在了版本号为 <code v-pre>421b0f</code>位置处，可以切换到 master 分支查看 Test.java 内容:</p>
...
<p>使用 Git 不仅可以将我们的本地代码提交到 Github 仓库，同时也可以通过 Git 把 Github 上的项目克隆到本地。我们已经学会了<a href="#_link_git1">如何在 Github 上发现优秀的开源项目</a>，比如此时你在 Github 上找到了一个好的开源项目，存储库在 <strong>CodingLifeVV/hello-world</strong> 下，克隆该仓库内容流程如下</p>
<ol>
<li>
<p>在本地电脑上新建一个本地存储库，初始化为一个本地仓库</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">git</span> init
...
<p>将 master 分支内容推送到其它分支上，以 dev 分支为例，步骤如下：</p>
<ol>
<li>
<p>查看分支日志，记录 master 分支想要推送的版本号</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 切换到 master 分支</span>
...
<li>
<p>切换到 dev 分支，拉取代码</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 切换分支</span>
<span class="token function">git</span> checkout dev
<span class="token comment"># 拉取代码</span>
<span class="token function">git</span> pull
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>将 master 分支内容推送到 dev分支</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">git</span> cherry-pick 5f640689ac75a31400a1a7b5f2c208be311e5586
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ol>
</div></template>
