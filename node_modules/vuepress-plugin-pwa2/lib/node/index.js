import{useSassPalettePlugin as y}from"vuepress-plugin-sass-palette";import{Logger as z,getRootLang as S,getLocales as j,addViteOptimizeDepsExclude as C,useCustomDevServer as x}from"vuepress-shared/node";import{fs as h,chalk as g,path as f,getDirname as P}from"@vuepress/utils";import{generateSW as T}from"workbox-build";import{ensureEndingSlash as O}from"@vuepress/shared";const m=new z("vuepress-plugin-pwa2"),v=({options:e,deprecatedOption:a,newOption:n,msg:i="",scope:s=""})=>{if(a in e){if(m.warn(`"${a}" is deprecated${s?` in ${s}`:""}, please use "${n}" instead.${i?`
${i}`:""}`),n.includes(".")){const p=n.split(".");let t=e;p.forEach((o,l)=>{l!==p.length-1?(t[o]=t[o]||{},t=t[o]):t[o]=e[a]})}else e[n]=e[a];delete e[a]}},$=e=>{v({options:e,deprecatedOption:"cacheMaxSize",newOption:"maxSize"}),v({options:e,deprecatedOption:"popupComponent",newOption:"updateComponent"})},W=async(e,a)=>{var n,i,s;const{dir:p,siteData:t}=e,{base:o}=e.options,l=p.source(".vuepress/public/manifest.webmanifest"),r=p.source(".vuepress/public/manifest.json"),c=a.manifest||{},d=JSON.parse(h.existsSync(l)?await h.readFile(l,"utf8"):h.existsSync(r)?await h.readFile(r,"utf8"):"{}");return{name:t.title||((n=t.locales["/"])==null?void 0:n.title)||"Site",short_name:t.title||((i=t.locales["/"])==null?void 0:i.title)||"Site",description:t.description||((s=t.locales["/"])==null?void 0:s.description)||"A site built with vuepress",lang:S(e),start_url:o,scope:o,display:"standalone",theme_color:a.themeColor||"#46bd87",background_color:"#ffffff",orientation:"portrait-primary",prefer_related_applications:!1,...d,...c}},A=async(e,a)=>{m.load("Generating manifest.webmanifest");const{dir:n}=e,i=n.dest("manifest.webmanifest");await h.writeJSON(i,await a,{flag:"w"}),m.succeed(),m.update(`Manifest generated and saved to ${g.cyan(f.relative(process.cwd(),i))}!`)},N=(e,a=1024)=>n=>{const i=[],s=[],p=[".png",".jpg",".jpeg","webp","bmp","gif"];for(const t of n)if(p.some(o=>t.url.endsWith(o))){const o=h.statSync(f.resolve(e,t.url));o.size>a*1024?i.push(`Skipped ${t.url}, as it's ${Math.ceil(o.size/1024)} KB.`):s.push(t)}else s.push(t);return{warnings:i,manifest:s}},D=async(e,a)=>{var n;m.load("Generating service worker");const{dest:i}=e.dir,{title:s,locales:p}=e.siteData,t=i("service-worker.js"),o=f.relative(process.cwd(),i()),l=["**/*.{js,css,svg,woff,woff2,eot,ttf,otf}"];a.cacheHTML?l.push("**/*.html"):l.push("./index.html","./404.html"),a.cachePic&&l.push("**/*.{png,jpg,jpeg,bmp,gif,webp}"),await T({swDest:t,globDirectory:o,cacheId:s||((n=p["/"])==null?void 0:n.title)||"hope",globPatterns:l,cleanupOutdatedCaches:!0,clientsClaim:!0,maximumFileSizeToCacheInBytes:(a.maxSize||2048)*1024,manifestTransforms:[N(o,a.maxPicSize)],...a.generateSWConfig||{}}).then(({count:r,size:c,warnings:d})=>{m.succeed(),m.info(`Precache ${g.cyan(`${r} files`)}, totaling ${g.cyan(`${(c/1024/1024).toFixed(2)} Mb.`)}.`),d.length&&m.warn(`
${d.map(I=>`  · ${I}`).join(`
...
`)},k=(e={},a=!1)=>n=>{a&&$(e),n.env.isDebug&&m.info(`Options: ${e.toString()}`);const{base:i,shouldPrefetch:s=!0}=n.options;e.appendBase&&H(i,e),s===!0&&m.warn('The plugin will register service worker to handle assets, so we recommend you to set "shouldPrefetch: false" in VuePress config file.');const p=W(n,e);return n.options.head=L(e,i,n.options.head),y(n,{id:"hope"}),{name:"vuepress-plugin-pwa2",define:()=>({PWA_LOCALES:j({app:n,name:"pwa",default:w,config:e.locales}),SW_FORCE_UPDATE:e.update==="force",SW_PATH:e.swPath||"service-worker.js"}),extendsBundlerOptions:(t,o)=>{C({app:o,config:t},["mitt","register-service-worker"]),x(t,o,"/manifest.webmanifest",async()=>JSON.stringify(await p),"Unexpected manifest generate error")},onGenerated:async t=>{await A(t,p),await D(t,e)},clientConfigFile:t=>E(t,e)}};export{k as default,w as pwaLocales,k as pwaPlugin};
