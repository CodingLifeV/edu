...
import { ArticleIcon, CategoryIcon, TagIcon, TimelineIcon, } from "@theme-hope/modules/blog/components/icons/index.js";
import { useNavigate, useThemeLocaleData, } from "@theme-hope/composables/index.js";
import { useArticles, useCategoryMap, useStars, useTagMap, } from "@theme-hope/modules/blog/composables/index.js";
            ...
            active.value === "article"
                ? h(DropTransition, () => [
                    h("div", { class: "sticky-article-wrapper" }, [
                        ...
                        h("hr"),
                        h("ul", { class: "sticky-article-list" }, stars.value.items.map(({ info, path }, index) => h(DropTransition, { appear: true, delay: 0.08 * (index + 1) }, () => h("li", {
